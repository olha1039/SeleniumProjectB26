...
//3. Wait until loading bar disappears
       ...
       // BrowserUtils.waitForInvisibilityOf(dynamicallyLoadedPage1.loadingBar); doing the same job as those two lo=ines above, but with the help of utility class
...
//8. Assert “Your password is invalid!” text is displayed.
        Assert.assertTrue(dynamicallyLoadedPage1.errorsMsg.isDisplayed());
